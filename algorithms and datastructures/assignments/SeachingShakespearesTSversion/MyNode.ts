...
export class MyNode {
  ...
  public addChild(substring: string, wholeWord: string): void {
  ...
  public getWordFromChildren() {
    ...
    this.children.forEach(node => {
      node.getWordFromChildren().forEach(v => resList.add(v));
    });
    return resList;
  }

  public find(substring: string, orginalSubstring: string): any {
